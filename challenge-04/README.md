...
carro.obterMarcaModelo = () => `Esse carro é um ${carro.obterCor()} ${carro.obterModelo()}`
...
carro.adicionarPessoas = (pessoas) => {
    if (pessoas < 0) {
        ...
        return `${pessoas} pessoa(s) sairam do carro!`
    }
    ...
    if (pessoas + carro.quantidadePessoas > carro.assentos) {
